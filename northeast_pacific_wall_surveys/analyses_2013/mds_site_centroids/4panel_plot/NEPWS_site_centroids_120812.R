# Robin Elahi
# 19 Aug 2013, modified for a 4 panel plot
# 12 August 2012
...
###############################################################
# plot 4 panels
par(mfcol=c(2,2), pty="m", mar=c(0.5, 3, 0.5, 0.5), oma=c(0,2,2,0))
...
# SSE      2.305924  1.328559  1.07514  0.8542193  0.6495143
# calinski 8.922406 12.776613 10.92371 10.4156092 10.8720364
           # 7 groups  8 groups   9 groups 10 groups 11 groups
# SSE       0.5267594  0.433888  0.3594558 0.2982043 0.2416295
# calinski 10.6676500 10.397468 10.1164428 9.8176371 9.7055054
         # 12 groups 13 groups 14 groups   15 groups
# SSE      0.1917581 0.1511285  0.111793  0.07278339
# calinski 9.6714631 9.4861199  9.578227 10.36060697
           # 16 groups
# SSE       0.03495727
# calinski 13.56652891
...
legend("bottomleft", "c", adj=c(2,1), bty='n', cex=1.5)
...
legend("topleft", "d", adj=c(2,0), bty='n', cex=1.5)
